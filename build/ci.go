...
import (
	...
	"github.com/fiwallets/go-ethereum/crypto/signify"
	"github.com/fiwallets/go-ethereum/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/fiwallets/go-ethereum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/fiwallets/go-ethereum/internal/version.gitDate="+env.Date)
	}
